This folder contains code that was implemented to perform clustering of 0's and 1's hand-written digit images from ups_all.mat data file. The KMeans algorithm was implemented from scratch.  
