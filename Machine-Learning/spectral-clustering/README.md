This folder contains implementation of Spectral clustering algorithm to a football league data set by building a network of games played with different teams and identifying clusters.  
