...
# Removed the columns after extraction : fullgame,supported_languages,header_image,website,legal_notice,drm_notice,ext_user_account_notice,developers,publishers,demos,
steam_columns = [
    'type', 'name', 'steam_appid', 'required_age', 'is_free', 'controller_support',
    'dlc', 'short_description', 'pc_requirements', 'mac_requirements',
    'linux_requirements', 'price_overview', 'packages', 'package_groups',
